...
void
jwt_base64_init_encodestate (base64_encodestate * state_in)
{
...
size_t
jwt_base64_encode_block (const char *plaintext_in, size_t length_in,
...
size_t
jwt_base64_encode_blockend (char *code_out, base64_encodestate * state_in)
{
  char               *codechar = code_out;
